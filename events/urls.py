...
from .views import HomePageView,DashBoardView,EventsPageView,AboutPageView,ContactPageView,PrivacyPolicyPageView,BlogPageView,single_post,CheckOutPageView,PaymentPageView
